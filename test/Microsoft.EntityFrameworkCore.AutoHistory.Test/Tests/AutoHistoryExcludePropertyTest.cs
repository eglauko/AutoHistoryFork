...
public class AutoHistoryExcludePropertyTest
{
    ...
    public void Entity_Update_AutoHistory_Exclude_Changed_Test()
    {
        ...
        blog.PrivateURL = "http://new.secret.com";
        blog.ExcludedProperty = "new value";
    ...
    [Fact]
    public void Excluded_Entity_Update_AutoHistory_OnlyModified_Changed_Test_2()
    {
        using var db = new BloggingContext();
        var notTracked2 = new NotTracked2 { Title = "don't track me" };

        db.Attach(notTracked2);
        db.SaveChanges();

        notTracked2.Title = "still not tracked";
        db.EnsureAutoHistory();
